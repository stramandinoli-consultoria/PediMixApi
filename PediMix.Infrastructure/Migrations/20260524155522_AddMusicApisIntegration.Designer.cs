...
namespace PediMix.Infrastructure.Migrations
{
    ...
    [Migration("20260524155522_AddMusicApisIntegration")]
    partial class AddMusicApisIntegration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PediMix.Domain.Entities.ExternalArtist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PediMix.Domain.Entities.SongExternalData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<bool>("HasLyricsAvailable")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.ToTable("SongExternalData");
                });

            modelBuilder.Entity("PediMix.Domain.Entities.SongLyrics", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("SyncedLyricsJson")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("PediMix.Domain.Entities.SongExternalData", b =>
                {
                    b.HasOne("PediMix.Domain.Entities.Song", "Song")
                        .WithOne()
                        .HasForeignKey("PediMix.Domain.Entities.SongExternalData", "SongId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
